...
<section>
    <div class="userInfoPerso">
        ...
        <p><?= $city->isAdmin($user['userID']) ? 'Administrat.eur.rice' : '' ?></p>
    </div>
    ...
    if (!empty($userIdeas))
    {
        foreach ($userIdeas as $idea)
        {
            ...
            <div class="cardHeart">
                ...
                <button role="button" onclick="toggleHeart()" name="button">
                    <svg viewBox="0 -20 480 480" id=$ideaID aria-expanded='false'>
